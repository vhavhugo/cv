                        ...
                        <div class="panel-heading text-center">
                            <div class="panel-tools">
                               ...
                               <div class="text-right">
                                   <a href="<?php echo base_url('cadastrar-categoria-blog'); ?>" class="btn btn-w-md btn-primary">Cadastrar Novo</a>
                                </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="tableExample3" class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php foreach ($catblog as $cat): ?>
                                    <tr>
                                        <td class="categoria-blog"><?php echo $cat['catblog_nome']; ?></td>
                                        <td class="text-center">
                                         
                                    <a href="<?php echo site_url('catblog/editar/'.$cat['catblog_id']); ?>" class="btn btn-primary " ><i class="fa fa-paste"></i></a>  
                                    <button data-link="<?php echo site_url('catblog/excluir/'.$cat['catblog_id']); ?>/"
