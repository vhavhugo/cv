...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets_painel/vendor/toastr/toastr.min.css'); ?>"/>
                    ...
                    <div class="col-lg-12">
                        <div class="view-header">
                            <div class="pull-right text-right" style="line-height: 14px">
                                <small>Luna Admin Theme<br>Dashboard<br> <span class="c-white">v.1.2</span></small>
                            </div>
...
<script src="<?php echo base_url('assets_painel/vendor/toastr/toastr.min.js'); ?>"></script>
<script src="<?php echo base_url('assets_painel/vendor/sparkline/index.js'); ?>"></script>
<script src="<?php echo base_url('assets_painel/vendor/flot/jquery.flot.min.js'); ?>"></script>
<script src="<?php echo base_url('assets_painel/vendor/flot/jquery.flot.resize.min.js'); ?>"></script>
<script src="<?php echo base_url('assets_painel/vendor/flot/jquery.flot.spline.js'); ?>"></script>
