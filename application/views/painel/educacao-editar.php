                        ...
                        <div class="row">
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    <?php echo form_open('educacao/create/'.$educacao['educacao_id']); ?>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="form-group">
                                            <label for="educacao_nome">Nome</label> 
                                            <input type="input" name="educacao_nome" class="form-control" id="educacao_nome" placeholder="Informe o nome"
                                             value="<?php echo $educacao['educacao_nome'] ?>"/>
                                        </div>
                                    </div>
                                    
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <label for="educacao_data">Duração</label> 
                                            <input type="input" name="educacao_data" class="form-control" id="educacao_data" placeholder="Informe a duração"
                                             value="<?php echo $educacao['educacao_data'] ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="educacao_desc">Descrição</label> 
                                            <textarea type="textarea" name="educacao_desc" class="form-control" id="educacao_desc">
                                                <?php echo $educacao['educacao_desc']; ?>
                                            </textarea>
                                        </div>
                                    </div>
