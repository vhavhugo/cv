                    ...
                    <div class="panel panel-filled">
                        <div class="panel-heading text-center">
                            ...
                            <div class="text-right">
                               <a href="<?php echo base_url('lista-educacao'); ?>" class="btn btn-w-md btn-primary">Voltar para lista</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    <?php echo form_open('educacao/create'); ?>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <label for="educacao_nome">Duração</label> 
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="textarea" name="educacao_desc" class="form-control" id="educacao_desc"></textarea>
                                        </div>
                                    </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
