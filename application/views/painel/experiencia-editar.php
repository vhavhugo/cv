                        ...
                        <div class="row">
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    <?php echo form_open('experiencia/create/'.$experiencia['experiencia_id']); ?>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="input" name="experiencia_nome" class="form-control" id="experiencia_nome" placeholder="Informe o nome"
                                             value="<?php echo $experiencia['experiencia_nome'] ?>"/>
                                        </div>
                                    </div>
                                    
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <label for="experiencia_data">Duração</label> 
                                            <input type="input" name="experiencia_data" class="form-control" id="experiencia_data" placeholder="Informe a duração"
                                             value="<?php echo $experiencia['experiencia_data'] ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="experiencia_desc">Descrição</label> 
                                            <textarea type="textarea" name="experiencia_desc" class="form-control" id="experiencia_desc">
                                                <?php echo $experiencia['experiencia_desc']; ?>
                                            </textarea>
                                        </div>
                                    </div>
