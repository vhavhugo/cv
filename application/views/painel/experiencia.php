                        ...
                        <div class="panel-heading text-center">
                            <div class="panel-tools">
                               ...
                               <div class="text-right">
                                   <a href="<?php echo base_url('cadastrar-experiencia'); ?>" class="btn btn-w-md btn-primary">Cadastrar Novo</a>
                                </div>
                        </div>

                       <?php print_r($experiencia); ?>
                            ...
                            <div class="table-responsive">
                                <table id="tableExample3" class="table table-striped table-hover">
                                    ...
                                    <tr>
                                     ...
                                     <tbody>
                                        <?php if(isset($experiencia) && sizeof($experiencia) > 0): ?>
                                        <?php foreach ($experiencia as $ser): ?>
                                    <tr>
                                        <td class=""><?php echo $ser['experiencia_nome']; ?></td>
                                        <td class="text-center">
                                         
                                    <a href="<?php echo site_url('experiencia/editar/'.$ser['experiencia_id']); ?>" class="btn btn-primary " ><i class="fa fa-paste"></i></a>  
                                    <button data-link="<?php echo site_url('experiencia/excluir/'.$ser['experiencia_id']); ?>/"
