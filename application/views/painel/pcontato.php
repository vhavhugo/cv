                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    $dados = array('enctype' => 'multipart/form-data');
                                     echo form_open_multipart('pcontato/create/1', $dados); 
                                     ?>
                                
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <div class="form-group">
                                            <label for="pcontato_titulo">Título</label> 
                                            <input type="input" name="pcontato_titulo" class="form-control" id="pcontato_titulo" placeholder="Informe o título"
                                             value="<?php echo $pcontato['pcontato_titulo'] ?>"/>
                                        </div>

                                        <div class="form-group">
                                            <label for="pcontato_sub">Sub-título</label> 
                                            <input type="input" name="pcontato_sub" class="form-control" id="pcontato_sub" placeholder="Informe o sub-título"
                                             value="<?php echo $pcontato['pcontato_sub'] ?>"/>
                                        </div>
                                   ...
                                   <div class="col-md-2 col-sm-2 col-xs-12 text-center form-group">
                                        ...
                                        <div class="form-group">
                                            <?php if ($pcontato['pcontato_imagem'] != "" ): ?>
                                                <img src="<?= base_url() ?>uploads/thumb.php?zcc=1&w=440&h=250&src=pcontato/<?= $pcontato['pcontato_imagem'] ?>" alt="..." id="img-foto-antes" class="img-thumbnail img-responsive">
                                            <?php else : ?>
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <span class="btn btn-primary btn-file btn-block">
                                                ...
                                                <input type="file" id="pcontato_imagem" name="pcontato_imagem" class="form-control">
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="pcontato_desc">Descricao</label> 
                                            <textarea type="textarea" name="pcontato_desc" class="form-control" id="pcontato_desc">
                                             <?php echo $pcontato['pcontato_desc'] ?>
                                             </textarea>
                                        </div>
                                    </div>
