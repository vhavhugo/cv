                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    $dados = array('enctype' => 'multipart/form-data');
                                     echo form_open_multipart('psobre/create/1', $dados); 
                                     ?>
                                
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        <div class="form-group">
                                            <label for="psobre_titulo">Título</label> 
                                            <input type="input" name="psobre_titulo" class="form-control" id="psobre_titulo" placeholder="Informe o título"
                                             value="<?php echo $psobre['psobre_titulo'] ?>"/>
                                        </div>

                                        <div class="form-group">
                                            <label for="psobre_sub">Sub-título</label> 
                                            <input type="input" name="psobre_sub" class="form-control" id="psobre_sub" placeholder="Informe o sub-título"
                                             value="<?php echo $psobre['psobre_sub'] ?>"/>
                                        </div>
                                   ...
                                   <div class="col-md-2 col-sm-2 col-xs-12 text-center form-group">
                                        ...
                                        <div class="form-group">
                                            <?php if ($psobre['psobre_imagem'] != "" ): ?>
                                                <img src="<?= base_url() ?>uploads/thumb.php?zcc=1&w=440&h=250&src=psobre/<?= $psobre['psobre_imagem'] ?>" alt="..." id="img-foto-antes" class="img-thumbnail img-responsive">
                                            <?php else : ?>
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <span class="btn btn-primary btn-file btn-block">
                                                ...
                                                <input type="file" id="psobre_imagem" name="psobre_imagem" class="form-control">
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="psobre_desc">Descricao</label> 
                                            <textarea type="textarea" name="psobre_desc" class="form-control" id="psobre_desc">
                                             <?php echo $psobre['psobre_desc'] ?>
                                             </textarea>
                                        </div>
                                    </div>
