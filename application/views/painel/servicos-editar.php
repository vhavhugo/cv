                        ...
                        <div class="row">
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    <?php echo form_open('servicos/create/'.$servicos['servicos_id']); ?>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="form-group">
                                            <label for="servicos_nome">Nome</label> 
                                            <input type="input" name="servicos_nome" class="form-control" id="servicos_nome" placeholder="Informe o nome"
                                             value="<?php echo $servicos['servicos_nome'] ?>"/>
                                        </div>
                                    </div>
