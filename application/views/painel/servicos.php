                        ...
                        <div class="panel-heading text-center">
                            <div class="panel-tools">
                               ...
                               <div class="text-right">
                                   <a href="<?php echo base_url('cadastrar-servicos'); ?>" class="btn btn-w-md btn-primary">Cadastrar Novo</a>
                                </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="tableExample3" class="table table-striped table-hover">
                                    ...
                                    <tr>
                                        <td class=""><?php echo $ser['servicos_nome']; ?></td>
                                        <td class="text-center">
                                         
                                    <a href="<?php echo site_url('servicos/editar/'.$ser['servicos_id']); ?>" class="btn btn-primary " ><i class="fa fa-paste"></i></a>  
                                    <button data-link="<?php echo site_url('servicos/excluir/'.$ser['servicos_id']); ?>/"
                                   ...
                                   <?php endforeach; ?>
                                   <?php else: ?>
                                        <p class="alert alert-warning">Nenhum serviço cadastrado!</p>
                                    <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
