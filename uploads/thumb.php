 ...
 *
 * Implementado codigo para inclus�o e defini��o da posi��o da marca d'�gua
 *
...
if (file_exists ($src)) {
	...
	/* 
		...
		- $marcax e $marcay s�o utilizados para pegar as dimens�es da marca d�agua
		- $pos_m_x e $pos_m_y s�o utilizados para centralizar a marca d'�gua
